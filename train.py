...
if args.data_set == 'cifar':
    ...
    import data.stl10_data as stl_data
    DataLoader = stl_data.DataLoader
else:
    ...
    for epoch in range(args.max_epochs):
        ...
        if epoch == 0:
            ...
            if args.load_params and args.ckpt_folder_drive_dir:
                ...
                saver.restore(sess, os.path.join(args.ckpt_folder_drive_dir, 'params_' + args.data_set + '.ckpt-%s' % args.load_params))
